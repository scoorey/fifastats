...
$scope.consoles ={};
    ...
    $scope.cons = '';
    $scope.consoles.console = 'Xbox One';
    $scope.grade = 'C';
  ...
  //record
    ...
    $scope.defensiveFormations = ['5-3-2', '5-2-1-2','5-2-2-1', '4-3-3(3)', '4-2-3-1'];
	...
	$scope.fetch = function(){
		console.log('hekp');
		var url = 'http://www.easports.com/fifa/api/fifa15-xboxone/stats/fut/scoorey';
